...
public class LangZhCn extends LanguageProvider
{
    ...
    protected void addTranslations()
    {
        ...
        add("gui.neosim.cityChoose.title","选择城市");
        ...
        add("gui.neosim.npc.title","NPC 交互");
        add("gui.neosim.npc.talk","对话");
        add("gui.neosim.npc.interact","交互");
        add("gui.neosim.npc.gift","礼物");
        add("gui.neosim.npc.setSkin","设置皮肤");
        add("gui.neosim.npc.rename","重命名");
        add("gui.neosim.npc.back","← 返回");
        add("gui.neosim.npc.follow","跟随");
        add("gui.neosim.npc.stay","停留");
        add("gui.neosim.npc.teleportTo","传送到NPC");
        add("gui.neosim.npc.teleportHere","NPC传送到我");
        ...
        add("gui.neosim.npc.info.health","生命值: %s / %s");
        add("gui.neosim.npc.info.skin","皮肤: %s");
        add("gui.neosim.npc.info.noCity","无");
        add("gui.neosim.npc.info.noSkin","未设置");

        add("gui.neosim.npc.rename.input","输入新姓名…");
