...
public class MiningBox extends Block
{
	public MiningBox(Properties properties)
	{
		super(properties);
	}
	...
	public void setPlacedBy(Level level, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack)
	{
		...
		{
			WorkPlotEngine.createMinePlot((ServerLevel) level, pos, player.getName().getString());
		}
	}
	...
	public InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hitResult)
	{
		...
		{
			ClientBlockInteractions.openMiningBox(pos);
		}
	...
	private boolean isInteractive(BlockPos pos)
	{
		...
		return ClientBlockInteractions.hasMiningBoxRecord(pos);
	}
}
