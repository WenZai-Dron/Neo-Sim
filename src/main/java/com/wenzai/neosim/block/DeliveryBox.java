...
public class DeliveryBox extends Block
{
	public DeliveryBox(Properties properties)
	{
		super(properties);
	}
	...
	public boolean onDestroyedByPlayer(BlockState state, Level level, BlockPos pos, Player player, boolean willHarvest, FluidState fluid)
	{
		...
		{
			DeliveryEngine.removeBoxAt(sl, pos);
		}
	...
	public InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hitResult)
	{
		...
		{
			ClientBlockInteractions.openDeliveryBox(pos);
		}
	...
	private boolean isInteractive(BlockPos pos)
	{
		...
		return ClientBlockInteractions.hasDeliveryBoxRecord(pos);
	}
}
